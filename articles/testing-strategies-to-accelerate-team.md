...
テスト設計は目的である開発速度を維持することやリグレッションを防ぐことために、最も重要なスキルです。どのテストでどこまで担保し、何をしないのか、何をモックにするのか、テスト粒度はどうやって揃えるのか、など考えることは多岐にわたります。幸い、これらの観点については書籍などから体系的に学ぶことが可能です。

### 設計・書き方などのチーム内統一

少数のリードするエンジニアが設計や書き方を学んでも、これらをチームで運用するには全員が一定以上の理解度やスキルを習得する必要があります。テストに限らず、チームに設計や書き方を共有することはそれ自体が難しいことです。

筆者は**ペアプログラミング・モブプログラミング**でこれらの課題を解決してきた経験が多いので、ここでも同様にペアプログラミング・モブプログラミングを推奨します。ペアプログラミング・モブプログラミングではお互いに苦手領域をフォローしあったり、観点漏れをリアルタイムに指摘しあえます。

時折これらに対し、「効率が悪い」という指摘を耳にすることがありますが、実際には[フロー効率](https://qiita.com/hirokidaichi/items/f59e611772c02f2e74ee)的には効率が良く、総アウトプット量も増えることも多々あります。

todo: ペアプロの記事
todo: リーンとDevopsの科学よりリードタイムにフォーカスすることの研究について言及
...
具体的にはテスティングフレームワークやテスト設計自体のハードスキルを伴う難しさと、それらを知識やスキルをチーム内でお互いに共有しチーム全体で統一された運用をするソフトスキルを伴う難しさです。ハードスキルは少数のリードエンジニアの手腕によって得られる効果が変わってきます。ソフトスキルについてはチームの心理的安全性や文化が大きく影響してきます。

### テスティングフレームワークの知識やテスト設計

テストの運用には、導入をリードするエンジニアが必要です。リードするエンジニアは、前述のハードスキルを習得している必要があります。テスティングフレームワークについては公式ドキュメントを読み、ある程度使い方や環境構築については習得しておきましょう。テスト設計について学ぶなら前述の[単体テストの考え方/使い方](https://book.mynavi.jp/ec/products/detail/id=134252)や[テスト駆動開発](https://shop.ohmsha.co.jp/shopdetail/000000004967/)、[Clean Craftsmanship](https://tatsu-zine.com/books/clean-craftsmanship)などがおすすめです。

フロントエンドに限れば[フロントエンド開発のためのテスト入門](https://www.shoeisha.co.jp/book/detail/9784798178189)がテスティングフレームワークから設計まで幅広くフォローしてるのでおすすめです。

書籍以外にも学ぶ方法はあると思いますが、筆者は技術書から学ぶのも好きなのでこれらをお勧めします。自分にあった本や習得方法を選んでみてください。
