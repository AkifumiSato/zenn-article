...
正しくテストを運用するには、相応の知識とスキルが必要になってきます。具体的にはテスティングフレームワークやテスト設計自体のハードスキルを伴う難しさと、それらを知識やスキルをチーム内でお互いに共有しチーム全体で統一された運用をするソフトスキルを伴う難しさです。ハードスキルは少数のリードエンジニアの手腕によって得られる効果が変わってきます。ソフトスキルについてはチームの心理的安全性や文化が大きく影響してきます。
