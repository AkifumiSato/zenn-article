...
確かに、dynamic rendering を含むページでもPPR なら TTFBを SSG 相当にすることが可能です。しかし、パフォーマンスというのはTTFBだけで測るものではありません。例えばTime to InteractiveにおいてはPPRでもSSRでも大きくは変わらないため、ページ全体をSSGにできるならその方が理論上早くなります。
